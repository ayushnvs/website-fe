...
const RegistrationPage = () => {
  return (
    <div className='bg-body-tertiary pb-4 pt-4'>
      ...
      <p className="nav justify-content-center h5 mt-4 fw-normal">Please register</p>
      <div className='d-flex align-items-center'>
        <main className="form-signin w-100 m-auto">
          <form>
            ...
            <div className='mt-4 mb-4'>Already have an account? <a href="/login">Login here</a></div>
          </form>
        </main>
      </div>
    </div>
